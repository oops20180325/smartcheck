<template>
  <div class="person">
      <el-row :gutter="20" class='tHead' align='middle' type='flex' >
        <el-col :span="6"><div class="tit">激光甲烷遥视云台点位设置</div></el-col>
      ...
      <el-dialog title="点位管理" :visible.sync="dialogFormVisible"  width='700' top='12vh' >
        <el-form :model="form">
          ...
          <el-form-item label="阈值" :label-width="formLabelWidth" >
            <el-input v-model="form.LimitMax" autocomplete="off"><template slot="append">mmp.m</template></el-input>
          </el-form-item>
...
<script>
import api from '../../api/ch4point.js'
