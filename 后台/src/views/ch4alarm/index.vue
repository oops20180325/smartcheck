<template>
  <div class="person">
      <el-row :gutter="20" class='tHead' align='middle' type='flex' >
        <el-col :span="6"><div class="tit">激光甲烷遥视云台报警记录</div></el-col>
              ...
              <el-col v-for="item in tableData" :key="item.Id" class="wa" :span="6">
                <el-card  :body-style="{ padding: '0px' }"  shadow="hover" style="width:100%">
                  ...
                  <div style="padding: 5px;">
                    <div class="">
                      设备名称:{{item.MethaneName}}
                    </div>
                    <div class="">
                      点位名称:{{item.MethanePoint}}
                    </div>
                    <div class="">
                      检测时间:{{item.Dt}}
                    </div>
      ...
      <el-dialog title="详情" :visible.sync="dialogFormVisible"  width='700' top='12vh' >
        <el-form :model="form" >
          <el-form-item label="设备名称" :label-width="formLabelWidth" >
            <el-input v-model="form.MethaneName" autocomplete="off" disabled></el-input>
          </el-form-item>
           <el-form-item label="点位名称" :label-width="formLabelWidth" >
            <el-input v-model="form.MethanePoint" autocomplete="off" disabled></el-input>
          </el-form-item>
          <el-form-item label="巡检时间" :label-width="formLabelWidth" >
            <el-input v-model="form.Dt" autocomplete="off" disabled></el-input>
          </el-form-item>
           <el-form-item label="报警阈值" :label-width="formLabelWidth" >
            <el-input v-model="form.LimitMax" autocomplete="off" disabled></el-input>
          </el-form-item>
          <el-form-item label="点位读值" :label-width="formLabelWidth">
            <el-input v-model="form.Val" autocomplete="off" disabled><template slot="append">mmp.m</template></el-input>
          </el-form-item>
          <!--
          <el-form-item label="报警原因" :label-width="formLabelWidth">
            <el-select v-model="form.Cause" clearable placeholder="请选择" class="w-full">
              <el-option label="误报" value="误报"> </el-option>
            </el-select>
          </el-form-item>
          -->
          <el-form-item label="备注" :label-width="formLabelWidth" >
              <el-input v-model="form.Remark" placeholder='' disabled autocomplete="off"></el-input>
          </el-form-item>
