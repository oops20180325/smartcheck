<template>
  <div class="person">
      <el-row :gutter="20" class='tHead' align='middle' type='flex' >
        <el-col :span="6"><div class="tit">红外双视遥测报警记录</div></el-col>
      ...
      <el-dialog title="详情" :visible.sync="dialogFormVisible"  width='700' top='12vh' >
        <el-form :model="form" >
         <el-form-item label="设备名称" :label-width="formLabelWidth" >
            <el-input v-model="form.InfraredName" autocomplete="off" disabled></el-input>
          </el-form-item>
           <el-form-item label="点位名称" :label-width="formLabelWidth" >
            <el-input v-model="form.InfraredPoint" autocomplete="off" disabled></el-input>
          </el-form-item>
